        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative" style={{ zIndex: 2 }}>
          ...
          <div className="flex justify-center space-x-12 mb-16">
            ...
            >
              ...
              <span className="mt-2 text-sm text-gray-400 group-hover:text-white transition-all duration-300">GitHub</span>
            </a>
            ...
            <a 
              ...
              className="social-icon group flex flex-col items-center"
            >
              <div className="text-gray-400 group-hover:text-blue-400 transition-all duration-300">
                <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <span className="mt-2 text-sm text-gray-400 group-hover:text-blue-400 transition-all duration-300">LinkedIn</span>
            </a>
